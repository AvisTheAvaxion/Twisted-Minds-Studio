...
public class Dialogue
{
    ...
    string[] VarrenEncounter = new string[]
    {
        ...
        "$Emote|Protag|Surprised",
        //Line above is a test line
        "Varren: It's a hotel, and it's where you'll be spending the rest of your days, trapped here for eternity because of all of the terrible things you've done.|He must be joking.|terrible things?$Prompt",
